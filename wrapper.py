'''
EE660
sklearn compatible wrapper for QNS3VM
credit: https://github.com/tmadl/semisup-learn/blob/master/methods/scikitTSVM.py
'''
...
class SKTSVM(BaseEstimator):
    ...
    def __init__(self, kernel = 'RBF', C = 1e-4, gamma = 0.5, lamU = 1.0, probability=False):
